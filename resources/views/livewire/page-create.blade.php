<div>
    ...
    <form class="w-full">
        ...
        <div class="grid mb-5 lg:grid-cols-2 lg:gap-6">
            ...
            {{-- <div class="col-span-1">
                <label for="short_description" class = 'mb-4 text-sm font-medium text-gray-600 dark:text-white'>
                    {{ __('Short Description') }}
                </label>
                <x-text-input id="short_description" class="block w-full mt-1" type="text" name="short_description" wire:model='short_description'
                    required autofocus placeholder="Short Description" />
            ...
            <div class="">
                ...
                <x-select-option wire:model='position' class="block w-full mt-1" id="position"
                    ...
                    <option value="hero_sections">Hero Sections</option>
            ...
            {{-- <div class="">
                <x-input-label for="position" :value="__('Show Link In Product Detail')" />
                <x-select-option wire:model='link_in_product_detail' class="block w-full mt-1" id="position"
                    name='pistion'>
